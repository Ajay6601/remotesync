...
class User(Base):
    ...
    sent_connections = relationship("UserConnection", foreign_keys="UserConnection.requester_id")
    received_connections = relationship("UserConnection", foreign_keys="UserConnection.receiver_id")
